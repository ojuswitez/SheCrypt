...
window.cash = (function () {
    ...
    Object.defineProperty(y, 'constructor', { value: g }),
        (g.parseHTML = f),
        (g.noop = e),
        (g.isFunction = l),
        (g.isString = h),
        ...
        ((O = {
            ...
            (D = (function () {
                ...
                var t,
                    ...
                    s = { linear: B(0.25, 0.25, 0.75, 0.75) },
                    o = {};
                for (t in e)
                    (o.type = t),
                        e[o.type].forEach(
                                ...
                                value: function () {
                                    ...
                                    this._updateVars(),
                                        ...
                                        this.placeholder.css({
                                            width:
                                                this.placeholder[0].getBoundingClientRect().width + 'px',
                                            height:
                                                this.placeholder[0].getBoundingClientRect().height + 'px',
                                            position: 'relative',
                                            top: 0,
                                            left: 0,
                                        }),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.options.showClearBtn &&
                                        (_(this.clearBtn).css({ visibility: '' }),
